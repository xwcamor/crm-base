...
/*
|--------------------------------------------------------------------------
| Discounts module — tunable knobs
|--------------------------------------------------------------------------
|
| Clon de config/warehouses.php adaptado al modulo Discounts (per-tenant).
...
return [
    ...
    /**
     * Export — limites por formato. Mismo razonamiento que Warehouses:
     ...
     */
    'export_limits' => [
        'csv'   => env('DISCOUNTS_EXPORT_LIMIT_CSV',   0),
        'excel' => env('DISCOUNTS_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('DISCOUNTS_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('DISCOUNTS_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('DISCOUNTS_EXPORT_MEMORY', '512M'),
];
