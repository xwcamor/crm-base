...
/*
|--------------------------------------------------------------------------
| Messages module — tunable knobs
|--------------------------------------------------------------------------
|
| Clon de config/discounts.php adaptado al modulo Messages (super-only).
...
return [
     ...
     */
    'export_limits' => [
        'csv'   => env('MESSAGES_EXPORT_LIMIT_CSV',   0),
        'excel' => env('MESSAGES_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('MESSAGES_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('MESSAGES_EXPORT_LIMIT_WORD',  10000),
    ],

    /**
     * Memory limit para los jobs de export.
     */
    'export_job_memory_limit' => env('MESSAGES_EXPORT_MEMORY', '512M'),
];
