...
abstract class PaymentTestCase extends TestCase
{
    ...
    protected function seedRolesAndPermissions(): void
    {
        ...
        foreach ([
            'payments.view', 'payments.create', 'payments.edit', 'payments.delete', 'payments.show',
            'invoices.view', 'companies.view',
        ] as $perm) {
    ...
    /** Helper — crea un invoice del tenant con totales. */
    protected function makeInvoice(int $tenantId, array $overrides = []): Invoice
    {
        ...
        return Invoice::factory()->create(array_merge([
            ...
            'amount_paid' => 0,
            'balance_due' => 1000.00,
            'number'      => 'INV-PAY-' . strtoupper(Str::random(4)),
        ], $overrides));
    }
}
