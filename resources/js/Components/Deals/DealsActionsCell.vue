...
<template>
    ...
    <div v-if="isMobile" class="row-actions-mobile" @click.stop>
        <Tooltip :title="t('global.view')">
            <Link :href="route('crm.deals.show', record.slug)">
                <Button
                    type="text"
                    class="row-icon-btn"
        ...
        <Tooltip v-if="canEdit" :title="t('deals.edit_hint')">
            <Button
                type="text"
                class="row-icon-btn"
        ...
        <Tooltip v-if="canDelete" :title="t('deals.delete_hint')">
            <Link :href="route('crm.deals.delete', record.slug)">
                <Button
                    type="text"
                    danger
                    class="row-icon-btn"
    ...
    <Space v-else :size="4" class="row-actions-desktop" @click.stop>
        ...
        <Tooltip v-if="canEdit" :title="t('deals.edit_hint')">
            <Link :href="route('crm.deals.edit', record.slug)">
