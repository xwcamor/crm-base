<script setup>
/**
 * Bulk bar de Deliveries. A diferencia de Customer (activate/deactivate),
 * Deliveries expone bulk update de status: el padre muestra un Select para
        ...
        <Space wrap>
            ...
            <template v-if="canEdit">
                ...
                <Button size="small" :loading="bulkActivating" @click="applyStatus">
                    <CheckCircleOutlined /> {{ $t('deliveries.bulk_set_status') }}
                </Button>
            </template>
            <Button
                v-if="canDelete"
