<script setup>
/**
 * Tabla editable in-line del flujo Edit-All de Plans. Recibe `draft` via
    ...
    <table v-if="draft.length > 0" class="edit-table">
        <thead>
            <tr>
                ...
                <th class="col-slug">{{ $t('plans.slug') }}</th>
                <th class="col-name">{{ $t('plans.table_headers.editable_name') }}</th>
                <th class="col-status">{{ $t('plans.table_headers.editable_status') }}</th>
            </tr>
        </thead>
        <tbody>
            <tr
            ...
            >
                ...
                <td class="col-slug"><code>{{ row.slug }}</code></td>
                <td class="col-name">
                    <Input
...
.edit-table .col-slug   { width: 160px; font-family: ui-monospace, Consolas, monospace; }
