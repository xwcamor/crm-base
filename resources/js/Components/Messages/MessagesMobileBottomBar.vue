<script setup>
/** Bottom bar mobile [Filtros][Crear][Otros]. Oculta si hay seleccion. */
...
<template>
    <div class="mobile-bottom-bar">
        ...
        <Button type="primary" class="mbb-btn mbb-btn--primary" @click="$emit('create')">
            <PlusOutlined />
...
.mbb-btn { flex: 1; height: 44px !important; display: inline-flex !important; align-items: center; justify-content: center; gap: 6px; font-weight: 500; position: relative; }
.mbb-btn span:not(.mbb-btn__dot) { font-size: 0.875rem; }
.mbb-btn__dot { position: absolute; top: 8px; right: 12px; width: 8px; height: 8px; border-radius: 50%; background: var(--color-danger-bright); }
