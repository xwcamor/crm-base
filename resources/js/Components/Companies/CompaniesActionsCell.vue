...
<template>
    ...
    <div v-if="isMobile" class="row-actions-mobile" @click.stop>
        <Tooltip :title="t('global.view')">
            <Link :href="route('crm.companies.show', record.slug)">
                <Button
                    type="text"
                    class="row-icon-btn"
        ...
        <Tooltip v-if="canEdit" :title="t('companies.edit_hint')">
            <Button
                type="text"
                class="row-icon-btn"
        ...
        <Tooltip v-if="canDelete" :title="t('companies.delete_hint')">
            <Link :href="route('crm.companies.delete', record.slug)">
                <Button
                    type="text"
                    danger
                    class="row-icon-btn"
    ...
    <Space v-else :size="4" class="row-actions-desktop" @click.stop>
        ...
        <Tooltip v-if="canEdit" :title="t('companies.edit_hint')">
            <Link :href="route('crm.companies.edit', record.slug)">
