...
<template>
    ...
    <div v-if="isMobile" class="row-actions-mobile" @click.stop>
        <Tooltip :title="t('global.view')">
            <Link :href="route('crm.contacts.show', record.slug)">
                <Button
                    type="text"
                    class="row-icon-btn"
        ...
        <Tooltip v-if="canEdit" :title="t('contacts.edit_hint')">
            <Button
                type="text"
                class="row-icon-btn"
        ...
        <Tooltip v-if="canDelete" :title="t('contacts.delete_hint')">
            <Link :href="route('crm.contacts.delete', record.slug)">
                <Button
                    type="text"
                    danger
                    class="row-icon-btn"
    ...
    <Space v-else :size="4" class="row-actions-desktop" @click.stop>
        ...
        <Tooltip v-if="canEdit" :title="t('contacts.edit_hint')">
            <Link :href="route('crm.contacts.edit', record.slug)">
