    ...
    <table v-if="draft.length > 0" class="edit-table">
        <thead>
            <tr>
                ...
                <th class="col-cod">{{ $t('customers.cod') }}</th><!-- @scaffold:remove-line -->
        ...
        <tbody>
            ...
            >
                ...
                <!-- @scaffold:remove-begin commercial-edit-cell -->
                <td class="col-cod">
...
.edit-table .col-cod    { width: 150px; font-family: ui-monospace, Consolas, monospace; font-size: 0.8125rem; } /* @scaffold:remove-line */
...
@media (max-width: 768px) {
    ...
    .edit-table .col-cod { display: none; } /* @scaffold:remove-line */
