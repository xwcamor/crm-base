<script setup>
/**
 * Tabla editable in-line del flujo Edit-All de Quotes. Recibe `draft` por
    ...
    <table v-if="draft.length > 0" class="edit-table">
        <thead>
            <tr>
                ...
                <th class="col-name">{{ $t('quotes.table_headers.editable_name') }}</th>
                <th class="col-status">{{ $t('quotes.table_headers.editable_status') }}</th>
            </tr>
        </thead>
        <tbody>
            <tr
