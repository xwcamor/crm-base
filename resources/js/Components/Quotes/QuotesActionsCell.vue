...
<template>
    ...
    <div v-if="isMobile" class="row-actions-mobile" @click.stop>
        ...
        <Tooltip v-if="canEdit" :title="t('quotes.edit_hint')">
            <Button
                type="text"
                class="row-icon-btn"
        ...
        <Tooltip v-if="canDelete" :title="t('quotes.delete_hint')">
            <Link :href="route('business_management.quotes.delete', record.slug)">
                <Button
                    type="text"
                    danger
                    class="row-icon-btn"
    ...
    <Space v-else :size="4" class="row-actions-desktop" @click.stop>
        ...
        <Tooltip v-if="canEdit" :title="t('quotes.edit_hint')">
            <Link :href="route('business_management.quotes.edit', record.slug)">
