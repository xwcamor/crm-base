...
<template>
    ...
    <div v-if="isMobile" class="row-actions-mobile" @click.stop>
        ...
        <Tooltip v-if="canEdit" :title="t('invoices.edit_hint')">
            <Button
                type="text"
                class="row-icon-btn"
        ...
        <Tooltip v-if="canDelete" :title="t('invoices.delete_hint')">
            <Link :href="route('business_management.invoices.delete', record.slug)">
                <Button
                    type="text"
                    danger
                    class="row-icon-btn"
    ...
    <Space v-else :size="4" class="row-actions-desktop" @click.stop>
        ...
        <Tooltip v-if="canEdit" :title="t('invoices.edit_hint')">
            <Link :href="route('business_management.invoices.edit', record.slug)">
