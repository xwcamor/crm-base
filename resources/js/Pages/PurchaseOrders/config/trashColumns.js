 ...
 */
export const purchaseOrdersTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('purchase_orders.reference'), dataIndex: 'reference',           key: 'reference',   ellipsis: true, mobile: { role: 'title' } },
    { title: t('purchase_orders.supplier'),  dataIndex: ['supplier', 'name'],  key: 'supplier',    width: 200, mobile: { role: 'meta' } },
    { title: t('purchase_orders.status'),    dataIndex: 'status',              key: 'status',      width: 140, mobile: { role: 'status' } },
