...
export const leadSourcesTableColumns = (t, { isSuper = false } = {}) => [
    ...
    { title: t('lead_sources.name'),         dataIndex: 'name',        key: 'name',       sorter: (a, b) => a.name.localeCompare(b.name), alwaysVisible: true, mobile: { role: 'title' } },
    { title: t('lead_sources.category'),     dataIndex: 'category',    key: 'category',   width: 160, mobile: { role: 'meta' } },
    { title: t('lead_sources.sort_order'),   dataIndex: 'sort_order',  key: 'sort_order', width: 100, align: 'right', mobile: { role: 'meta' }, defaultHidden: true },
    ...(isSuper ? [
        { title: t('tenants.singular'),      dataIndex: ['tenant', 'name'], key: 'tenant', width: 180, mobile: { role: 'meta' } },
    ] : []),
    { title: t('lead_sources.is_active'),    dataIndex: 'is_active',   key: 'status',     width: 110, align: 'center', mobile: { role: 'status' } },
