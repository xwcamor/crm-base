...
export const productCategoriesTableColumns = (t, { isSuper = false } = {}) => [
    ...
    { title: t('product_categories.name'),   dataIndex: 'name',        key: 'name',       sorter: (a, b) => a.name.localeCompare(b.name), alwaysVisible: true, mobile: { role: 'title' } },
    { title: t('product_categories.parent'), dataIndex: ['parent', 'name'], key: 'parent', width: 200, mobile: { role: 'meta' } },
    { title: t('product_categories.sort_order'), dataIndex: 'sort_order', key: 'sort_order', width: 100, align: 'right', mobile: { role: 'meta' }, defaultHidden: true },
    ...(isSuper ? [
        { title: t('tenants.singular'), dataIndex: ['tenant', 'name'], key: 'tenant', width: 180, mobile: { role: 'meta' } },
    ] : []),
    { title: t('product_categories.is_active'), dataIndex: 'is_active', key: 'status',     width: 110, align: 'center', mobile: { role: 'status' } },
