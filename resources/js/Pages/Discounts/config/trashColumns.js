 ...
 */
export const discountsTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('discounts.code'),            dataIndex: 'code',                key: 'code',        width: 150, mobile: { role: 'meta' } },
    { title: t('discounts.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
