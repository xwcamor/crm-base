...
return [
    ...
    'id'              => 'No.',
    'name'            => 'Name',
    'name_hint'       => 'Readable locale name, usually including the country (e.g. Spanish (Peru)).',
    'code'            => 'Code',
    'code_hint'       => 'BCP-47 format: 2 lowercase letters and optional _ with 2 uppercase (es, es_PE).',
    'language'        => 'Language',
    'language_hint'   => 'Master language this locale belongs to.',
    'is_active'       => 'Status',
    'is_active_hint'  => 'If inactive, it will not appear in locale selectors.',
