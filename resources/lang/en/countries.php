...
return [
    ...
    'id'              => 'No.',
    'name'            => 'Name',
    'name_hint'       => 'Official country name as it should be shown in the UI.',
    'iso_code'        => 'ISO code',
    'iso_code_hint'   => 'ISO 3166-1 alpha-2 two-letter uppercase code (PE, BR, US).',
    'currency'        => 'Currency',
    'currency_hint'   => 'Local currency in ISO 4217 alpha-3 format (PEN, BRL, USD).',
    'timezone'        => 'Timezone',
    'timezone_hint'   => 'Timezone in IANA format (America/Lima). Used for default scheduling.',
    'region'          => 'Region',
    'region_hint'     => 'Geographic block the country belongs to.',
    'default_locale'  => 'Default locale',
    'default_locale_hint' => 'Regional variant used by default for users from this country.',
    'is_active'       => 'Status',
