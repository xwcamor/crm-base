...
return [
    ...
    'delete_about'    => 'Estás a punto de eliminar el módulo :name.',
    ...
    'id'              => 'N°',
    'name'            => 'Nombre',
    'name_hint'       => 'PascalCase singular (ej. "Patient"). El sistema genera el permission_key automáticamente.',
    'permission_key'  => 'Clave de permiso',
    'permissions'     => 'Permisos asociados',
    'is_active'       => 'Estado',
    'is_active_hint'  => 'Si está inactivo, los permisos asociados dejan de ser asignables.',
    ...
    'permissions_preview_hint'  => 'El Observer del modelo crea estos 6 permisos al guardar. Si cambiás el nombre, se renombran automáticamente.',
    ...
    'name_format_hint'        => 'Usá PascalCase singular (ej. "Patient", "Doctor"). El sistema lo convierte a "patients"/"doctors" para los permisos.',
