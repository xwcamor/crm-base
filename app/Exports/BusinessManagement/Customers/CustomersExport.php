 ...
 *
 * Clon de RegionsExport con columnas adicionales `cod` y `country` (relacion). // @scaffold:remove-line
 */
class CustomersExport implements FromCollection, WithEvents, WithTitle
{
    ...
    public function __construct($customers, array $options = [])
    {
        $this->customers = $customers instanceof Collection ? $customers : collect($customers);
        ...
        $this->columnDefs = [
            ...
            // @scaffold:remove-begin commercial-export-columns
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $headerRow  = 4;
                $dataStart  = 5;
                $dataEnd    = $dataStart + $this->customers->count() - 1;
