...
class CustomersWord
{
    ...
    public function generate(
        ...
        $this->columnDefs = [
            ...
            // @scaffold:remove-begin commercial-word-columns
        ...
        $brandCell->addText(
            __('global.generated_at') . ': ' . now()->setTimezone($tz)->format(\App\Support\Tz::DATETIME_FORMAT) . ' · ' . trans_choice('global.records_in_report', count($customers), ['count' => count($customers)]),
