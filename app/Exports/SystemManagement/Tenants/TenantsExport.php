...
class TenantsExport implements FromCollection, WithEvents, WithTitle
{
    ...
    public function __construct($tenants, array $options = [])
    {
        $this->tenants = $tenants instanceof Collection ? $tenants : collect($tenants);
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $headerRow  = 4;
                $dataStart  = 5;
                $dataEnd    = $dataStart + $this->tenants->count() - 1;
