...
class TenantsWord
{
    ...
    public function generate(
        ...
        $brandCell->addText(
            __('global.generated_at') . ': ' . now()->setTimezone($tz)->format(\App\Support\Tz::DATETIME_FORMAT) . ' · ' . trans_choice('global.records_in_report', count($tenants), ['count' => count($tenants)]),
