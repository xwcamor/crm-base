...
class LanguagesExport implements FromCollection, WithEvents, WithTitle
{
    ...
    public function __construct($languages, array $options = [])
    {
        $this->languages = $languages instanceof Collection ? $languages : collect($languages);
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $headerRow  = 4;
                $dataStart  = 5;
                $dataEnd    = $dataStart + $this->languages->count() - 1;
