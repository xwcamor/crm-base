...
class SystemModulesExport implements FromCollection, WithEvents, WithTitle
{
    ...
    public function __construct($system_modules, array $options = [])
    {
        $this->system_modules = $system_modules instanceof Collection ? $system_modules : collect($system_modules);
    ...
    public function collection()
    {
        ...
        $count    = $this->system_modules->count();
        $subtitle = sprintf(
            '%s · %s · %s',
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $headerRow  = 4;
                $dataStart  = 5;
                $dataEnd    = $dataStart + $this->system_modules->count() - 1;
