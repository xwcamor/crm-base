...
class SystemModulesWord
{
    ...
    public function generate(
        ...
        $brandCell->addText(
            __('global.generated_at') . ': ' . now()->setTimezone($tz)->format(\App\Support\Tz::DATETIME_FORMAT) . ' · ' . trans_choice('global.records_in_report', count($system_modules), ['count' => count($system_modules)]),
