...
class CountriesExport implements FromCollection, WithEvents, WithTitle
{
    ...
    public function __construct($countries, array $options = [])
    {
        $this->countries = $countries instanceof Collection ? $countries : collect($countries);
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $headerRow  = 4;
                $dataStart  = 5;
                $dataEnd    = $dataStart + $this->countries->count() - 1;
