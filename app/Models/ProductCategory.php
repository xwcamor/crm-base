...
/**
 * ProductCategory — taxonomia jerarquica de productos del catalogo.
 *
 * Tier 1 parity con Customer/Discount/Warehouse master template:
...
class ProductCategory extends Model
{
    ...
    protected string $auditModule = 'product_categories';
    ...
    public function scopeFilter($query, $request)
    {
        ...
        $query->when($request->filled('parent_id'), fn ($q) => $q->where("{$tbl}.parent_id", $request->parent_id));
    ...
    {
        return [
            ['key' => 'name',          'label' => __('product_categories.name'),       'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'sort_order',    'label' => __('product_categories.sort_order'), 'type' => 'number',  'operators' => ['=', '!=', '>', '<', '>=', '<=']],
            ['key' => 'is_active',     'label' => __('product_categories.is_active'),  'type' => 'boolean', 'operators' => ['=']],
