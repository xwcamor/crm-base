...
/**
 * TaxClass — master template del scaffold `php artisan make:module`.
 *
...
class TaxClass extends Model
{
    ...
    protected string $auditModule = 'tax_classes';
...
$query->when($request->has('is_active') && $request->is_active !== '', function ($q) use ($request, $tbl) {
     ...
     *   - key       : columna real de la BD (prefijada con `tax_classes.`)
    ...
    {
        return [
            ['key' => 'name',       'label' => __('tax_classes.name'),       'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('tax_classes.code'),       'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_default', 'label' => __('tax_classes.is_default'), 'type' => 'boolean', 'operators' => ['=']],
            ['key' => 'is_active',  'label' => __('tax_classes.is_active'),  'type' => 'boolean', 'operators' => ['=']],
