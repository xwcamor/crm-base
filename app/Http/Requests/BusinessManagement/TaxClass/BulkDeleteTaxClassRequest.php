...
class BulkDeleteTaxClassRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:tax_classes.delete ya gatea la ruta — este
        // authorize() esta aca por consistencia con el patron FormRequest.
        return $this->user()?->can('tax_classes.delete') ?? false;
    }
