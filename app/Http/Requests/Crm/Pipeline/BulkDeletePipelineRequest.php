...
class BulkDeletePipelineRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:pipelines.delete ya gatea la ruta — este
        // authorize() esta aca por consistencia con el patron FormRequest.
        return $this->user()?->can('pipelines.delete') ?? false;
    }
