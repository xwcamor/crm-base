 ...
 *
 * Clon de BaseRegionExportJob adaptado a Companies (per-tenant, con relacion
...
abstract class BaseCompanyExportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        ini_set('memory_limit', config('companies.export_job_memory_limit', '512M'));
    ...
    protected function buildQuery()
    {
        ...
        $base = Company::query()->withoutGlobalScopes();
...
if (isset($f['is_active']) && $f['is_active'] !== '' && $f['is_active'] !== null) {
    ...
    {
        $base = Str::slug($this->options['title'] ?? __('companies.export_filename'));
