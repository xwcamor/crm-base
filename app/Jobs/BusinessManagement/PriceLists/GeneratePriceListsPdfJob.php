...
class GeneratePriceListsPdfJob extends BasePriceListExportJob
{
    ...
    protected function executeExport(Download $download): void
    {
        ...
        $columns        = $this->options['columns']                 ?? ['id', 'name', 'currency_code', 'global_discount_pct', 'priority', 'is_default', 'is_active', 'created_at', 'creator'];
        ...
        $pdf = Pdf::loadView('business_management.price_lists.pdf.template', [
