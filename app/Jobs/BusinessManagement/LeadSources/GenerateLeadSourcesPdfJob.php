...
class GenerateLeadSourcesPdfJob extends BaseLeadSourceExportJob
{
    ...
    protected function executeExport(Download $download): void
    {
        ...
        $columns        = $this->options['columns']                 ?? ['id', 'name', 'category', 'sort_order', 'is_active', 'created_at', 'creator'];
        ...
        $pdf = Pdf::loadView('business_management.lead_sources.pdf.template', [
            'leadSources'    => $leadSources,
            'columns'        => $columns,
            'title'          => $title,
            'filtersSummary' => $filtersSummary,
            'generatedBy'    => $generatedBy,
            'totalCount'     => $leadSources->count(),
