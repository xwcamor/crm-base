...
class GenerateExchangeRatesPdfJob extends BaseExchangeRateExportJob
{
    ...
    protected function executeExport(Download $download): void
    {
        ...
        $columns        = $this->options['columns']                 ?? ['id', 'base_code', 'quote_code', 'rate', 'valid_at', 'source', 'is_active', 'created_at', 'creator'];
        ...
        $pdf = Pdf::loadView('business_management.exchange_rates.pdf.template', [
            'rates'          => $rates,
            'columns'        => $columns,
            'title'          => $title,
