...
class GenerateProductVariantsPdfJob extends BaseProductVariantExportJob
{
    ...
    protected function executeExport(Download $download): void
    {
        ...
        $columns        = $this->options['columns']                 ?? ['id', 'name', 'sku', 'product', 'price', 'is_active', 'created_at', 'creator'];
        ...
        $pdf = Pdf::loadView('business_management.product_variants.pdf.template', [
            'variants'       => $variants,
            'columns'        => $columns,
            'title'          => $title,
